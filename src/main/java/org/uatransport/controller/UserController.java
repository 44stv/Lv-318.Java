...
//        try {
//            user = userService.getUserDetailsByEmail(request.getEmail());
//        } catch (Exception e) {
//            //
//        }
//        if (user == null) {
//            try {
//                userService.saveUserFromSocialSignInRequest(request);
//            } catch (Exception e) {
//                //
//            }
//            user = userService.getUserDetailsByEmail(request.getEmail());
//        }
//        if (user != null) {
//            return ResponseEntity.ok(jwtTokenProvider.createToken(user.getUsername(), Role.USER));
//        }
