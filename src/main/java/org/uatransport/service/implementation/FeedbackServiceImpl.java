...
public class FeedbackServiceImpl implements FeedbackService {
    ...
    public Double getRatingByCategoryId(Integer categoryId) {
        List<Feedback> feedbackList = getByTransitCategoryIdAndFeedbackCriteria(categoryId,
    ...
    public Map<Integer, Double> getHourCapacityMap(Integer transitId) {
        ...
        for (int hour = 0; hour < 24; hour++) {
            capacityMap.put(hour, getAverageCapacityByTransitAndHour(hour, capacityHourFeedbackList));
        }
        return capacityMap;
    }
    ...
    private Double getAverageCapacityByTransitAndHour(Integer feedbackHour,
                                                      List<CapacityHourFeedback> capacityHourFeedbackList) {
